...
type Config struct {
	...
	DocuSeal struct {
		...
		Team1Role   string `toml:"team1_role"`
		Team2Role   string `toml:"team2_role"`
		RedirectURL string `toml:"completed_redirect_url"`
	} `toml:"docuseal"`
...
func defaultConfig() Config {
	...
	cfg.DocuSeal.BaseURL = "https://api.docuseal.com"
	cfg.DocuSeal.Team1Role = "Team 1"
	cfg.DocuSeal.Team2Role = "Team 2"
...
func Load(path string) (*Config, error) {
	...
	cfg.Catigoal.BaseURL = normalizeBaseURL(cfg.Catigoal.BaseURL)
	cfg.DocuSeal.BaseURL = strings.TrimRight(strings.TrimSpace(cfg.DocuSeal.BaseURL), "/")
